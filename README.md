...
Count occurrences of strings or regular expressions in commit messages. When commit sampling is used, all relevant previous commits before the sampled commit and after the previous sampled commit are counted.
